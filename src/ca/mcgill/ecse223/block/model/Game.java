...
public class Game implements Serializable
{
  ...
  private int nrBlocksPerLevel;
   // Comparator<HallOfFameEntry> hallOfFameEntriesPriority;
  private transient static final Comparator<HallOfFameEntry> hallOfFameEntriesPriority =
...
//  }
  ...
  // line 58 "../../../../../Block223Persistence.ump"
   public static  void reinitializeAutouniqueBlockId(List<Game> games){
    for (Game game : games){
